STYLES= [   
    ...
    "id":1,
    "name":"Classic",
    "description":"Simple and timeless designs that never go out of style.",
    "price":50.0
    },    
    {
    "id":2,
    "name":"Modern",
    "description":"Sleek and contemporary designs that are on-trend.",
    "price":75.0
    },    
    {
    "id":3,
    "name":"Vintage",
    "description":"Retro-inspired designs that have nostalgic charm.",
    "price":100.0
    }
]
